...
class ReparametrizedMixtureSameFamily(MixtureSameFamily):
    ...
    def rsample(self, sample_shape=torch.Size()):
        ...
        if event_size != 1:
            ...
            def batched_jacobian_of_reshaped_distributional_transform(x_2d):
                ...
                def reshaped_distributional_transform_summed(x_2d):
                    return torch.sum(
                            ...
                            dim=0)
                return jacrev(reshaped_distributional_transform_summed)(x_2d).detach().movedim(1, 0) #! a faster implementation
            ...
            # dimensions.
            jac = jac.to(transform_2d.dtype) #! would cause unknown bug?
