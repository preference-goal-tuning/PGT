...
SPAWN_FILE = FILE_DIR / "spawn.json"            # modify to deterministic spawn
# SPAWN_FILE = FILE_DIR / "spawn2.json"
...
DESCRIPTION_FILE = FILE_DIR / "description.json"
...
with open(DESCRIPTION_FILE, "r") as f:
    DESCRIPTION_CONSTANTS = json.load(f)
